...
public:
   ...
   * permitindo que este seja definido posteriormente através do método
   * setEmail.
   */
  Email() = default;
   ...
   * internamente o método setEmail para garantir que o valor fornecido é
   * validado.
   * * @param email String que contém o e-mail a ser armazenado.
   * @throw std::invalid_argument Se a string fornecida não respeitar o formato
   * válido.
   */
   ...
   * e-mail (comprimento da parte local, do domínio, utilização de pontos,
   * etc.).
